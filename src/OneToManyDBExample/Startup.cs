...
using OneToManyDBExample.Services;
using OneToManyDBExample.Interfaces;
using OneToManyDBExample.Respository;
...
namespace OneToManyDBExample
{
    public class Startup
    {
        ...
        public void ConfigureServices(IServiceCollection services)
        {
            ...
            //Our created Interface and Respository: 
            services.AddScoped<IGenericRespository, GenericRespository>();

            //Our created Category Interface:
            services.AddScoped<ICategoryService, CategoryService>();

            //Our created Movie Interface:
